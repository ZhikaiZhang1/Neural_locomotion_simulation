...
uicontrol('Style','text', 'Units','normalized','HorizontalAlignment','left',...
          'Position',[0.525  0.145 0.05 0.02],'string','-200');
uicontrol('Style','text', 'Units','normalized','HorizontalAlignment','right',...
          'Position',[0.775  0.145 0.05 0.02],'string','+200');
...
while quitflag==0
   ...
   if modeold ~= mode
        ...
        set(findobj('tag','inputcurrent'),'value',max(-200,min(200,I)));
